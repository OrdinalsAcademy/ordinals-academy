...
export default function Hero() {
	...
	const videoDate = 11; // Replace with your dynamic date value
	const videoLength = 27; // Replace with your dynamic video length
	...
	return (
		<div className="grid grid-cols-1 items-center md:grid-cols-2">
			<div className="md:ml-[200px] pl-24 text-customGray dark:text-customWhite">
				...
				<h1 className="text-6xl font-bold mb-5">{t('h1')}</h1>
			...
			<div className="p-16 pl-10 bg-white dark:bg-customGray">
				<div>
					<div className="uppercase font-bold mb-2">
						{t('featured')}
					</div>
